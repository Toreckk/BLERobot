...
#ifdef LED_PWM_PWMUDB_genblk1_ctrlreg__REMOVED
    #error PWM_v3_30 detected with a constant 0 for the enable or \
         constant 1 for reset. This will prevent the component from operating.
#endif /* LED_PWM_PWMUDB_genblk1_ctrlreg__REMOVED */
...
void LED_PWM_Init(void) 
{
        ...
        ctrl = LED_PWM_CONTROL & ((uint8)(~LED_PWM_CTRL_CMPMODE2_MASK)) &
                ((uint8)(~LED_PWM_CTRL_CMPMODE1_MASK));
    ...
    /* Globally disable the Fixed Function Block chosen */
        ...
        *******************************************************************************/
        void LED_PWM_SetCompareMode(uint8 comparemode) 
        {
                ...
                /*Clear existing mode */
                LED_PWM_CONTROL &= ((uint8)(~(LED_PWM_CTRL_CMPMODE1_MASK |
                                            LED_PWM_CTRL_CMPMODE2_MASK)));
    ...
    *******************************************************************************/
    uint8 LED_PWM_ReadCounter(void) 
    {
        ...
        /* It is up to the user code to make sure there isn't already captured data in the FIFO */
          (void)CY_GET_REG8(LED_PWM_COUNTERCAP_LSB_PTR_8BIT);
...
void LED_PWM_WritePeriod(uint8 period) 
{
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG8(LED_PWM_STATUS_PTR));
    }
