...
//This activity scans and displays all BLE devices that have a compatible UUID
...
public class BLEScanActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        mBleArrayAdapter = new ArrayAdapter<>(this, R.layout.device_list, R.id.ble_name, mBleName);
    ...
    private void scanLeDevice(final boolean enable) {
        if (enable) { // enable set to start scanning
            ...
            mScanning = true;
            UUID[] motorServiceArray = {RobotService.getMotorServiceUUID()};
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                //noinspection deprecation
                ...
                ParcelUuid PUuid = new ParcelUuid(RobotService.getMotorServiceUUID());
